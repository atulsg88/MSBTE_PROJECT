...
<!-- 					 <p>Don't have an account? <a href="Student?action=studentreg">Create one here</a></p> 
 -->				</div>	
			<form class="contact-bx" action=login?action=studlogin method="post">
					...
					<div class="row placeani">
						...
						<div class="col-lg-12">
							<div class="form-group form-forget">
								...
								<a href="login?action=studforgotpassword" class="ml-auto">Forgot Password</a>
							</div>
						</div>
