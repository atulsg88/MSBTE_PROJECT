	...
	<div class="account-form">
		...
		<div class="account-form-inner">
			<div class="account-container">
				...
				<form action="Institute?action=resetPassword" method="post">
						    <p style="color: red;text-align: center;"><%=request.getAttribute("alert")!=null?request.getAttribute("alert"):""%></p>
							<input type="hidden" name="institute_id" id="institute_id" value="<%= ib!=null?ib.getInstitute_id():"" %>">
						<div class="mb-3">
							<div class="mb-3">
							...
							<div class="mb-3">
								...
								<input type="password" name="confirm new password" id="confirm new password" class="form-control" title="Please enter confirm new password." placeholder="Please enter confirm new password." required/>
							</div>
						</div>
						<div class="col-lg-12">
