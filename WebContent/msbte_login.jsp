		...
		<div class="account-form-inner">
			<div class="account-container">
				<div class="heading-bx left">
					<h2 class="title-head">MSBTE<span>Login</span></h2>
					<p>Don't have an account? <a href="MSBTE?action=msbteregistration">Create one here</a></p>
				</div>	
				<form class="contact-bx" action="login?action=msbteLogin" method="post">
					...
					<div class="row placeani">
						...
						<div class="col-lg-12">
							<div class="form-group form-forget">
								...
								<a href="login?action=forgotpassword" class="ml-auto">Forgot Password</a>
							</div>
						</div>
