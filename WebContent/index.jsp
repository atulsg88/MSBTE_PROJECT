				...
				<div id="rev_slider_486_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.3.0.2">
					<ul>	<!-- SLIDE  -->
						...
						data-description="Science says that Women are generally happier">
							<!-- MAIN IMAGE -->
							<img src="assets/images/background/MSBTE  bg.jpg" alt="" 
						...
						data-easeout="default" 
						data-masterspeed="default" 
						data-thumb="assets/images/background/MSBTE  bg.jpg" 
						data-rotate="0" 
						data-fstransition="fade" 
						data-fsmasterspeed="1500" 
						data-fsslotamount="7" 
					...
					<div class="row">
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="service-bx">
								<div class="action-box">
									<img src="assets/images/our-services/msbte.jpg" alt="msbte">
								</div>
								<div class="info-bx text-center">
									<div class="feature-box-sm radius bg-white">
										<i class="fa fa-bank text-primary"></i>
									</div>
									<h4><a href="login?action=msbteLogin">MSBTE Login</a></h4>
									<a href="login?action=msbteLogin" class="btn radius-xl">Login</a>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="service-bx">
								<div class="action-box">
									<img src="assets/images/our-services/msbteinstitute.jpg" alt="institute">
								</div>
								<div class="info-bx text-center">
									<div class="feature-box-sm radius bg-white">
										<i class="fa fa-book text-primary"></i>
									</div>
									<h4><a href="login?action=instituteLogin">Institute Login</a></h4>
									<a href="login?action=instituteLogin" class="btn radius-xl">Login</a>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-4 col-sm-12">
							<div class="service-bx m-b0">
								<div class="action-box">
									<img src="assets/images/our-services/pic2.jpg" alt="student">
								</div>
								<div class="info-bx text-center">
									<div class="feature-box-sm radius bg-white">
										<i class="fa fa-file-text-o text-primary"></i>
									</div>
									<h4><a href="login?action=studentLogin">Student Login</a></h4>
									<a href="login?action=studentLogin" class="btn radius-xl">Login</a>
								</div>
							</div>
						</div>
					</div>
